...
/* length of the trx_serial_num info in the special comment. */
#define MAX_TSN_LEN 64
/* length of the Goldendb gtm_gtid info in the special comment. */
#define MAX_GTID_LEN 32
/* max pos in binlog file, max 'my_off_t' number to string length, 2^64-1 */
#define MAX_BINLOG_POS_NUMLEN 20
/* gtmgtid_idx file name suffix is ".gtid_idx", length without '\0' */
#define GTMGTID_IDX_FILE_SUFFIX_LEN 9
...
#ifdef HAVE_ZSQL_CONNECT_ENGINE
/** Field has the connect engine flag. */
#define FIELD_HAS_CONNECT_FLAG (1 << 30) 
#endif // HAVE_ZSQL_CONNECT_ENGINE
...
enum SERVER_STATUS_flags_enum {
  ...
  */
  ...
  SERVER_STATUS_GROUP_BELOW_LWM =4,
  ...
  */
  ...
  SERVER_STATUS_GROUP_BELOW_HWM = (1UL << 15)
};
...
#define SERVER_STATUS_CLEAR_SET                                   \
  (SERVER_QUERY_NO_GOOD_INDEX_USED | SERVER_QUERY_NO_INDEX_USED | \
   ...
   SERVER_STATUS_GROUP_BELOW_LWM |\
   SERVER_STATUS_GROUP_BELOW_HWM)
...
/* server receive multi statements from net at once */
#define SERVER_MULTI_STATEMENTS_FIRST           1
/* end statement of multi statements */
#define SERVER_MULTI_STATEMENTS_MIDDLE          2
/* end statement of multi statements */
#define SERVER_MULTI_STATEMENTS_END             4

#define GROUP_NORMAL_OK              0    /* asynchronous and semisync normal. */
#define GROUP_BELOW_LWM_ALARM_ERR    1    /* quick-sync groups below low-water-mark*/
#define GROUP_BELOW_HWM_ALARM_ERR    2    /* quick-sync groups below normal. */
