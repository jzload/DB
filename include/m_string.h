...
#define DA_STR_MAX_LEN  (0xFFFFFFFFLL)
...
{
#if defined _WIN32
  return strnlen_s(s, DA_STR_MAX_LEN);
#else
  return strnlen(s, DA_STR_MAX_LEN);
#endif
}
...
extern char *int10_to_str_ff6(unsigned long val, char *dst);
