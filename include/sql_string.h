...
class String {
  ...
  */
  ...
  bool set(int num, const CHARSET_INFO *cs) { return set_int(num, false, cs); }
  bool set(uint num, const CHARSET_INFO *cs) { return set_int(num, true, cs); }
  bool set(long num, const CHARSET_INFO *cs) { return set_int(num, false, cs); }
  bool set(ulong num, const CHARSET_INFO *cs) { return set_int(num, true, cs); }
  ...
  */
  ...
  bool append_with_prefill(const char *s, size_t arg_length, size_t full_length,
                           char fill_char);
  bool append_with_prefill_to_char_ff(const char *s, size_t arg_length, size_t full_length,
                           char fill_char) ;
