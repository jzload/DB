...
ulong thd_spec_lock_wait_time(const void * thd);
...
size_t thd_get_serial_num_safe(void* thd, char *buf, size_t buflen);
size_t thd_get_gtm_gtid_safe(void* thd, char *buf, size_t buflen);
...
enum enum_sql_command {
  ...
  SQLCOM_CREATE_SRS,
  SQLCOM_DROP_SRS,
  SQLCOM_SHOW_QUICKSYNC_STATUS,
  SQLCOM_SHOW_THREADPOOL_STATUS,
  SQLCOM_COPY_TABLE,
  SQLCOM_SHOW_SLAVE_SYNCREPLAY_STATUS,
