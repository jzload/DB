...
#ifndef COMPONENTS_SERVICES_PSI_TABLE_H
#define COMPONENTS_SERVICES_PSI_TABLE_H

#include <mysql/components/component_implementation.h>
#include <mysql/components/services/psi_table_service.h>

REQUIRES_SERVICE_PLACEHOLDER(psi_table_v1);

#define PSI_TABLE_CALL(M) mysql_service_psi_table_v1->M

#endif /* COMPONENTS_SERVICES_PSI_TABLE_H */
