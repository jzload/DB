...
/**
  @file include/mysql/psi/psi_abi_idle_v1.h
  ABI check for mysql/psi/psi_idle.h, when using PSI_IDLE_VERSION_1.
  This file is only used to automate detection of changes between versions.
  Do not include this file, include mysql/psi/psi_idle.h instead.
*/
