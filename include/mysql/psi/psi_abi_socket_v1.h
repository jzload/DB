...
/**
  @file include/mysql/psi/psi_abi_socket_v1.h
  ABI check for mysql/psi/psi_socket.h, when using PSI_SOCKET_VERSION_1.
  This file is only used to automate detection of changes between versions.
  Do not include this file, include mysql/psi/psi_socket.h instead.
*/
