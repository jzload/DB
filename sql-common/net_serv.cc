...
/* print error info after failure of network read or write */
static inline void record_errno_info() {
#ifdef MYSQL_SERVER
  if(unlikely(errno)) {
    char errmsg[256] = {0};
    sql_print_information("failed to read or write packet, errno: %d, errmsg: %s", 
