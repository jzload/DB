...
#ifdef HAVE_ZSQL_ORACLE_COMPATIBILITY
  // ROWNUM
  Item *rownum_condition() const { return m_rownum_condition; }
  void set_rownum_condition(Item *c) { m_rownum_condition = c; }
#endif /* HAVE_ZSQL_ORACLE_COMPATIBILITY */
...
#ifdef HAVE_ZSQL_ORACLE_COMPATIBILITY
  /**
    ROWNUM condition, extracted from where condition,
    especially used in update/delete single table statement.
  */
  Item *m_rownum_condition;
#endif /* HAVE_ZSQL_ORACLE_COMPATIBILITY */
...
#ifdef HAVE_ZSQL_ORACLE_COMPATIBILITY
  Item *rownum_condition() const { return m_qs->rownum_condition(); }
  void set_rownum_condition(Item *to) { return m_qs->set_rownum_condition(to); }
#endif /* HAVE_ZSQL_ORACLE_COMPATIBILITY */
