...
#ifdef HAVE_ZSQL_CONNECT_ENGINE
sys_var *find_plugin_sysvar(st_plugin_int *plugin, SYS_VAR *var);
#endif // HAVE_ZSQL_CONNECT_ENGINE
...
#ifdef HAVE_ZSQL_CONNECT_ENGINE
/* Has options for CONNECT engine */
#define HA_CREATE_WITH_ODBC_OPTIONS   (1L << 31)
#endif // HAVE_ZSQL_CONNECT_ENGINE
...
#ifdef HAVE_ZSQL_CONNECT_ENGINE
  LEX_STRING tabname_value{nullptr, 0};
  LEX_STRING option_list_value{nullptr, 0};
  LEX_STRING table_type_value{nullptr, 0};
  ///< list of table create options
  engine_option_value *option_list{nullptr};
#endif // HAVE_ZSQL_CONNECT_ENGINE
...
#ifdef HAVE_ZSQL_CONNECT_ENGINE
static inline sys_var *find_hton_sysvar(handlerton *hton, SYS_VAR *var)
{
...
class Alter_inplace_info {
  ...
  */
  static const HA_ALTER_FLAGS ALTER_PARTITIONED        = 1ULL << 49;
#endif // HAVE_ZSQL_CONNECT_ENGINE
...
class handler {
  ...
  */
  ...
  virtual uint has_foreign_key() { return 0;}   /* only valid in innodb */
