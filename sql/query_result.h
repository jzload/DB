...
class Query_result {
  ...
  */
  ...
  /**
    set the operation in send_data().
    Query_result_union override this function.
  */
  virtual void set_minus_op(bool) {}
#endif // HAVE_ZSQL_MINUS

#ifdef HAVE_ZSQL_MERGE_INTO
  /**
    Check in optimize if WHERE in MERGE INTO is optimized to impossible.
    Query_result_merge override this function.
  */
  virtual bool no_merge_result_attached() { return false; }
