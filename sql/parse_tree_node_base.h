...
enum enum_parsing_context {
  ...
  CTX_MERGE_INTO_UPDATE_WHERE, ///< MERGE INTO ... WHEN MATCHED THEN UPDATE ... WHERE (subquery)
  CTX_MERGE_INTO_INSERT_WHERE, ///< MERGE INTO ... WHEN NOT MATCHED THEN INSERT ... WHERE (subquery)
...
class Parse_tree_node_tmpl {
  ...
  */
  ...
  virtual void *clone(Parse_tree_transformer *) const {
