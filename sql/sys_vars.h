...
class Sys_var_gtmgtid_activelist : public Sys_var_charptr {
 public:
  Sys_var_gtmgtid_activelist(const char *name_arg, const char *comment, int flag_args,
                  ptrdiff_t off, size_t size, CMD_LINE getopt,
                  enum charset_enum is_os_charset_arg, const char *def_val)
      : Sys_var_charptr(name_arg, comment, flag_args, off, size, getopt,
                        is_os_charset_arg, def_val) {
         option.var_type = GET_STR_PTR;
  }

  ~Sys_var_gtmgtid_activelist() {}
