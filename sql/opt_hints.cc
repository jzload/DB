...
struct st_opt_hint_info opt_hint_info[] = {
    ...
    {"FULL_JOIN_ANTI",false,true,false},
#endif
    {0, 0, 0, 0}};
...
#ifdef HAVE_ZSQL_FULL_JOIN
void Opt_hints_qb::append_full_join_anti_hint(String *str) {
  if (full_join_anti_hint && full_join_anti_hint->type() == FULL_JOIN_ANTI_BLOCK_ENUM) {
    str->append(opt_hint_info[FULL_JOIN_ANTI_BLOCK_ENUM].hint_name);
    str->append(STRING_WITH_LEN("( ) "));
  }
}
#endif
