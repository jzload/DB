...
static const SYMBOL symbols[] = {
    ...
    */
    ...
    {SYM(">>", SHIFT_RIGHT)},
    {SYM("<=>", EQUAL_SYM)},
    {SYM("=>", MARK_SYM)}, /* HAVE_ZSQL_ORACLE_COMPATIBILITY */
    ...
    {SYM("CONNECT", CONNECT_SYM)}, //HAVE_ZSQL_START_WITH_CONNECT_BY
    ...
    {SYM("ELSIF", ELSEIF_SYM)}, /* HAVE_ZSQL_ORACLE_COMPATIBILITY */
    {SYM("EMPTY", EMPTY_SYM)},
    ...
    {SYM("GDB_FORMAT", GDB_FORMAT_SYM)},    /* HAVE_ZSQL_GDB_FORMAT */
    {SYM("GENERAL", GENERAL)},
    ...
    {SYM("PLS_INTEGER", INT_SYM)},  /* HAVE_ZSQL_ORACLE_COMPATIBILITY */
    {SYM("INT", INT_SYM)},
    ...
    {SYM("PRIOR", PRIOR_SYM)}, //HAVE_ZSQL_START_WITH_CONNECT_BY
    ...
    {SYM("VARCHAR2", VARCHAR2_SYM)}, /* HAVE_ZSQL_ORACLE_COMPATIBILITY */
    ...
    {SYM("||", OR_OR_SYM)},
    {SYM("FLAG", FLAG_SYM)},
    {SYM("OPTION_LIST", OPTION_LIST_SYM)},
    {SYM("TABLE_TYPE", TABLE_TYPE_SYM)},
    {SYM("TABNAME", TABNAME_SYM)},
    {SYM("QUICKSYNC", QUICKSYNC_SYM)},
    {SYM("THREADPOOL", THREADPOOL_SYM)},
#ifdef HAVE_ZSQL_COPY_TABLE
    {SYM("COPY", COPY_SYM)},
#endif // HAVE_ZSQL_COPY_TABLE
    {SYM("SYNCREPLAY", SYNCREPLAY_SYM)},
    /* #ifdef HAVE_ZSQL_ORACLE_COMPATIBILITY */
    {SYM("SYSDATE", SYSDATE_SYM)},
    {SYM("SYS_REFCURSOR", SYS_REFCURSOR_SYM)},
    {SYM("EXCEPTION", EXCEPTION_SYM)},
    {SYM("CLOB", CLOB_SYM)},
    {SYM("IMMEDIATE", IMMEDIATE_SYM)},
    {SYM("NOTFOUND", NOT_FOUND_SYM)},
    {SYM("SQLCODE", SQLCODE_SYM)},
    {SYM("SQLERRM", SQLERRM_SYM)},
#ifdef HAVE_ZSQL_ORACLE_COMPATIBILITY
    {SYM("ROWNUM",ROWNUM_SYM)},
    {SYM("WITHIN", WITHIN_SYM)},
    ...
    */
    ...
    {SYM_H("FULL_JOIN_ANTI",FULL_JOIN_ANTI_HINT)},
#endif
