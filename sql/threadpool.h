...
extern int threadpool_process_request(THD *thd, int *quicksync_refcount);
extern int threadpool_add_connection(THD *thd);
extern int  threadpool_append_commit_to_high_prio_queue(THD *thd);
extern void append_event_to_high_prio_queue(THD* thd);
...
extern int show_threadpool_waiting_threads(THD *thd, SHOW_VAR *var, char *buff);
extern int show_threadpool_active_threads(THD *thd, SHOW_VAR *var, char *buff);
extern void show_threadpool_status(THD *thd);
