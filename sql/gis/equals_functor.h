#ifndef SQL_GIS_EQUALS_FUNCTOR_H_INCLUDED
#define SQL_GIS_EQUALS_FUNCTOR_H_INCLUDED
...
/// used indirectly through the gis::equals() function.
///
/// @see gis::equals
...
/// Equals functor that calls Boost.Geometry with the correct parameter
/// types.
///
/// The functor throws exceptions and is therefore only intended used to
/// implement equals or other geographic functions. It should not be used
/// directly by other MySQL code.
class Equals : public Functor<bool> {
 private:
...
#endif  // SQL_GIS_EQUALS_FUNCTOR_H_INCLUDED
