...
#define  ROWNUM_IN_SELECT_LIST (1ULL << 0)
#define  ROWNUM_IN_WHERE_COND  (1ULL << 1)
#define  ROWNUM_IN_GROUP_FIELD (1ULL << 2)
#define  ROWNUM_IN_HAVING_COND (1ULL << 3)
#define  ROWNUM_IN_ORDER_FIELD (1ULL << 4)
#define  ROWNUM_ALL_FLAGS (ROWNUM_IN_SELECT_LIST | ROWNUM_IN_WHERE_COND | \
                           ROWNUM_IN_GROUP_FIELD  | ROWNUM_IN_HAVING_COND | \
                           ROWNUM_IN_ORDER_FIELD)
#define  ROWNUM_IN_SELECT_LIST_OR_HAVING (ROWNUM_IN_SELECT_LIST | ROWNUM_IN_HAVING_COND)
