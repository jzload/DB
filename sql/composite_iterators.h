...
class MaterializeIterator final : public TableRowIterator {
 ...
 private:
  ...
  /// See constructor.
  /// In ZSQL_MINUS feature, m_limit_rows need to be changed in
  /// MaterializeQueryBlocksWithLimit
  ...
  bool MaterializeQueryBlocksWithMinus(size_t last_minus_qb);
