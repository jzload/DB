...
bool check_valid_table_refs(const TABLE_LIST *view, List<Item> &values, table_map map);
...
@endverbatim
 ...
 public:
  ...
  virtual void update_parameters_for_insert_all(TABLE_LIST *table_list_par,
                                 TABLE *table_par, List<Item> *fields_par) {
    table_list = table_list_par;
    table      = table_par;
    fields     = fields_par;
    table->next_number_field = table_par->found_next_number_field;
    return;
  }
  void reset_bulk_insert_started_for_insert_all() { bulk_insert_started = false; }
...
#ifdef HAVE_ZSQL_INSERT_ALL
  bool prepare_inner_for_insert_all(THD *thd);
#endif /* HAVE_ZSQL_INSERT_ALL */
...
#ifdef HAVE_ZSQL_INSERT_ALL
  /* used for insert all stmt, is true all the time */
  bool is_insert_all_global;
  /* used for insert all stmt, become false in recursive function,
     become true when exit recursive function */
  bool is_insert_all_local;
  bool is_insert_all_last_table;
  ha_rows insert_all_affected_rows;
#endif /* HAVE_ZSQL_INSERT_ALL */
...
#ifdef HAVE_ZSQL_INSERT_ALL
  List<table_fields_pair> *insert_all_into_field_list;
#endif /* HAVE_ZSQL_INSERT_ALL */
...
#ifdef HAVE_ZSQL_INSERT_ALL
  List<table_values_pair> *insert_all_into_many_values;
#endif /* HAVE_ZSQL_INSERT_ALL */
...
#ifdef HAVE_ZSQL_INSERT_ALL
          is_insert_all_global     = false;
          is_insert_all_local      = false;
          is_insert_all_last_table = false;
          insert_all_affected_rows = 0;
#endif /* HAVE_ZSQL_INSERT_ALL */
  }
...
class Sql_cmd_insert_values : public Sql_cmd_insert_base {
 public:
  ...
  virtual void statistic_insert_all_affected_rows(THD *thd, ha_rows affected_rows, ulonglong id);
#endif /* HAVE_ZSQL_INSERT_ALL */
...
class Sql_cmd_insert_select : public Sql_cmd_insert_base {
 ...
 public:
  ...
  bool is_explain_insert_all_executed = false;
#endif /* HAVE_ZSQL_INSERT_ALL */
