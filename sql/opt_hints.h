...
class Opt_hints {
  ...
  */
  ...
  virtual bool ignore_print(opt_hints_enum type_arg) const {
    return type_arg == FULL_JOIN_ANTI_BLOCK_ENUM;
  }
#else
...
#ifdef HAVE_ZSQL_FULL_JOIN
  /* FULL JOIN */
  PT_qb_level_hint *full_join_anti_hint{nullptr};
#endif
  /*
...
#ifdef HAVE_ZSQL_FULL_JOIN
    append_full_join_anti_hint(str);
#endif
  }
...
#ifdef HAVE_ZSQL_FULL_JOIN
  /* FULL JOIN */
  PT_qb_level_hint *get_full_join_anti_hint()
  {
    return full_join_anti_hint;
  }
  void append_full_join_anti_hint(String *str);
#endif
