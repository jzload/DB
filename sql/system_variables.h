...
enum enum_length_semantics {
  SEMANTICS_BYTE = 0,
  SEMANTICS_CHAR = 1
};

#ifdef HAVE_ZSQL_ORACLE_COMPATIBILITY
enum enum_parse_mode : ulong {
  MYSQL_PARSE_MODE = 1,
  ORACLE_PARSE_MODE = 2
};
...
#define MODE_IGNORE_BAD_TABLE_OPTIONS (MODE_STRICT_ALL_TABLES * 2)
...
struct System_variables {
  ...
  */
  ...
  /* #ifdef HAVE_ZSQL_ORACLE_COMPATIBILITY */
  enum_parse_mode m_opt_parse_mode;  // 1. MYSQL_PARSE_MODE; 2. ORACLE_PARSE_MODE
  ulong m_listagg_max_len;
  /* #endif */
