...
PSI_memory_key key_memory_thd_main_sp_mem_root;
...
static PSI_memory_info all_server_memory[] = {
    ...
    {&key_memory_thd_main_mem_root, "thd::main_mem_root", PSI_FLAG_THREAD, 0,
     PSI_DOCUMENT_ME},
#ifdef HAVE_ZSQL_ORACLE_COMPATIBILITY
    {&key_memory_thd_main_sp_mem_root, "thd::main_sp_mem_root", PSI_FLAG_THREAD,
     0, PSI_DOCUMENT_ME},
#endif /* HAVE_ZSQL_ORACLE_COMPATIBILITY */
    ...
    {&key_memory_thread_pool_connection, "thread_pool_connection", 0, 0, PSI_DOCUMENT_ME}};
