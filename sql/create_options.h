...
#ifndef FRM_QUOTED_VALUE
#define FRM_QUOTED_VALUE 0x8000
#endif

enum { ENGINE_OPTION_MAX_LENGTH=32767 };

extern LEX_CSTRING tabname_str;
extern LEX_CSTRING option_list_str;
extern LEX_CSTRING table_type_str;
extern LEX_CSTRING connect_flag_str;
...
class engine_option_value
{
 public:
  ...
  {
    if ((value.str= (char *) root->Alloc(22)))
    {
