...
class Parse_tree_item : public Item {
 public:
  ...
  virtual bool b_fielditem_simple() const {
    return false;
  }

  /* #endif */
  void *clone(Parse_tree_transformer *) const { //HAVE_ZSQL_ORACLE_COMPATIBILITY
    my_error(ER_UNSUPPORTED_FUNCTION_IN_QUERY_EXPANSION, MYF(0));
    return nullptr;
  }
