...
class Sql_cmd_call_decl_block : public Sql_cmd_dml {
 public:
  explicit Sql_cmd_call_decl_block(sp_head *sp_arg)
      : Sql_cmd_dml(), sp(sp_arg) {}

  virtual enum_sql_command sql_command_code() const { return SQLCOM_DECL_BLOCK; }
