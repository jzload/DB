 ...
 */
 ...
 /**
   ...
   condition stack.
 */
virtual const COND *cond_push(const COND *cond, bool other_tbls_ok MY_ATTRIBUTE((unused)));
 ...
 */
  ...
  */
  int open(const char *name, int mode, uint test_if_locked,
           const dd::Table *table_def MY_ATTRIBUTE((unused)));    // required
...
//Item *idx_cond_push(uint keyno, Item* idx_cond);
  ...
  */
  ...
  int create(const char *name, TABLE *form,
             ...
             dd::Table *table_def MY_ATTRIBUTE((unused)));                      ///< required
