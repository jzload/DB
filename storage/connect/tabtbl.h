...
class TBTBLK : public TIDBLK {
 public:
  ...
  void * operator new(size_t, TIDBLK *sp) {return sp;}
...
class DllExport TDBTBM : public TDBTBL {
 ...
 public:
  ...
  // Database routines
	virtual int  Cardinality(PGLOBAL) { return 10; }
	virtual int  GetMaxSize(PGLOBAL) { return 10; } // Temporary
  virtual int  RowNumber(PGLOBAL g, bool b = false);
  virtual bool OpenDB(PGLOBAL g);
  virtual int  ReadDB(PGLOBAL g);
...
extern "C" void* ThreadOpen(void *p);
