...
int global_open(GLOBAL_CONNECT *g, int msgid, const char *filename, int flags);
int global_open(GLOBAL_CONNECT *g, int msgid, const char *filename, int flags, int mode);
