...
//virtual int   GetAffectedRows(void) {return 0;}
  virtual PSZ   GetFile(PGLOBAL) {return Ifile;}
  virtual void  SetFile(PGLOBAL, PSZ fn) {Ifile = fn;}
  virtual void  ResetDB(void) {Seclist = Section = NULL; N = 0;}
  virtual void  ResetSize(void) {MaxSize = -1; Seclist = NULL;}
  virtual int   RowNumber(PGLOBAL, bool MY_ATTRIBUTE((unused)) b = false ) {return N;}
