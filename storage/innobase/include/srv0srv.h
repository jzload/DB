...
#if 0   // HAVE_ZSQL_TSN_AND_LOCK_WAIT
  /** Thread writing lock wait log. */
  IB_thread m_lock_wait_snapshot;
...
extern uint srv_lock_wait_max_depth;
#endif  // HAVE_ZSQL_LOCK_DEPTH_LIMIT

#ifdef HAVE_ZSQL_TSN_AND_LOCK_WAIT
extern bool srv_lock_wait_log;
extern uint srv_lock_wait_collect_time;
extern char *srv_lock_wait_log_dir;
extern uint srv_lock_wait_log_size;
#endif  // HAVE_ZSQL_TSN_AND_LOCK_WAIT
...
extern bool srv_distributed_mvcc_purge_flag;

/** lower than this value must be purged*/
extern unsigned long long srv_distributed_mvcc_purge_gtmgtid;

/** timeout when there are none gtimgtid purge get*/
extern ulong srv_distributed_mvcc_purge_timeout;
#endif
...
#ifdef HAVE_ZSQL_TSN_AND_LOCK_WAIT
extern mysql_pfs_key_t lock_wait_snapshort_write_thread_key;
#endif  // HAVE_ZSQL_TSN_AND_LOCK_WAIT
...
struct export_var_t {
  ...
  ulonglong innodb_distributed_mvcc_purge_at_gtmgtid; /*!< gtmgtid purge at */
#ifdef UNIV_DEBUG
