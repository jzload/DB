...
struct trx_undo_t {
  ...
  ulonglong gtmgtid; /*!< GTMGTID for distribute mvcc
                   identification */
#endif
...
@param[in]	undo_log	undo log header */
ulonglong trx_undo_gtmgtid_read(trx_ulogf_t *undo_log);
#endif
...
#ifdef HAVE_ZSQL_DISTRIBUTE_MVCC
#define TRX_UNDO_FLAG_GTMGTID                 \
  0x04  /*!< TRUE if undo log header includes \
        GTMGTID information from distribute MVCC */
...
#ifdef HAVE_ZSQL_DISTRIBUTE_MVCC
#define TRX_UNDO_LOG_GTMGTID (TRX_UNDO_LOG_GTID_HDR_SIZE)

#define TRX_UNDO_LOG_GTMGTID_LEN 8

/** Total size of GTID information. */
#define TRX_UNDO_LOG_HDR_SIZE \
  (TRX_UNDO_LOG_GTMGTID + TRX_UNDO_LOG_GTMGTID_LEN)
#endif  // HAVE_ZSQL_DISTRIBUTE_MVCC
#include "trx0undo.ic"
#endif
