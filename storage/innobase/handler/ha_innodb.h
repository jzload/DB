...
class ha_innobase : public handler {
  ...
  */
  ...
  /**
    ...
    @param[in]  dict_tale     table in dictinary
   */
  inline void alter_table_set_gtid_flags2(TABLE *altered_table, dict_table_t *table);
  #endif
...
class create_table_info_t {
 public:
  ...
  #ifdef HAVE_ZSQL_DISTRIBUTE_MVCC
  /** Set the GTID bit in flags2 */
  void set_flags2_of_gtid();
  #endif
